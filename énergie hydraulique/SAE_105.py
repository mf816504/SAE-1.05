...
with open("hydraulique.csv", newline='', encoding="utf-8") as fichier: # Ouverture du fichier csv pour pouvoir le lire 
...
plt.title("Évolution de la production d'électricité hydraulique") # Ajoute un titre
